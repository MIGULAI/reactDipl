...
const AddCafedraForm = ({ cafedra, onSubmitForm, submitButtonValue = 'Додати'}) => {
        ...
        <div className={myClasses.formOneRow}>
            <div className={classes.columItem}>
                <div className={classes.inputFuild}>
                    <MyLabel >Назва кафедри :</MyLabel>
                    <MyFormInput
                        type="text"
                        placeholder={'Назва кафедри'}
                        register={{ ...register('cafedraName', { required: true }) }}
                    />
                    {
                        errors.positionName && <span>Введіть назву кафедри</span>
                    }
                </div>
            </div>
...
AddCafedraForm.propTypes = {
    onSubmitForm: PropTypes.func,
    submitButtonValue: PropTypes.string
}

export default AddCafedraForm